                    ...
                    <div class="navbar-wrapper">
                        <div class="navbar-logo" logo-theme="theme6">
                            <a href="#">
                                ...
                                <img class="img-fluid" src="../public/template_files/logo.png" alt="Theme-Logo">
                            </a>
                        ...
                        <div class="navbar-container container-fluid">
                            ...
                            <ul class="nav-right">
                                <li class="header-notification">
                                    <div class="dropdown-primary dropdown">
                                        ...
                                        <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <img class="img-radius" src="../public/template_files/avatar-4.jpg" alt="Generic placeholder image">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <img class="img-radius" src="../public/template_files/avatar-3.jpg" alt="Generic placeholder image">
                                                    <div class="media-body">
                                ...
                                <li class="user-profile header-notification">
                                    <div class="dropdown-primary dropdown">
                                        <div class="dropdown-toggle" data-toggle="dropdown">
                                            <img src="../public/template_files/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                            <span>John Doe</span>
                                    ...
                                    <div class="main-friend-list" style="overflow: hidden; width: auto; height: 519px;">
                                        ...
                                        >
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius img-radius" src="../public/template_files/avatar-3.jpg" alt="Generic placeholder image ">
                                        ...
                                        >
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="../public/template_files/avatar-2.jpg" alt="Generic placeholder image">
                                                <div class="live-status bg-success"></div>
                                            </a>
                                            <div class="media-body">
                                        ...
                                        >
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="../public/template_files/avatar-4.jpg" alt="Generic placeholder image">
                                                <div class="live-status bg-success"></div>
                                            </a>
                                            <div class="media-body">
                                        ...
                                        >
                                            <a class="media-left" href="#!">
                                                <img class="media-object img-radius" src="../public/template_files/avatar-3.jpg" alt="Generic placeholder image">
                        ...
                        <div class="main-friend-chat" style="overflow: hidden; width: auto; height: 444px;">
                            <div class="media chat-messages">
                                <a class="media-left photo-table" href="#!">
                                    <img class="media-object img-radius img-radius m-t-5" src="../public/template_files/avatar-2.jpg" alt="Generic placeholder image">
                                </a>
...
<script>
import SummaryVue from './components/SummaryData.vue'
